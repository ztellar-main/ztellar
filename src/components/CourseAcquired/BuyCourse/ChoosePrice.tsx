  ...
  return (
    <div className="">
      ...
      >
        ...
        {courseData?.coursePrices?.map((priceData: any, i: any) => {
          return (
            <option key={i} value={`${priceData?.months}/${priceData?.price}`}>
              {priceData?.months} months - {formatToPeso(priceData?.price)}
            </option>
          );
        })}
      </select>
